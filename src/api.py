...
from modules.models.text_process import preprocess, get_regex, html_add_mark_tag
        ...
        output.append(
            {
                ...
                "Oración_HTML": html_add_mark_tag(all_sentences_[idx], regex),
                "Título_HTML": html_add_mark_tag(all_titles_[idx], regex),
            }
        )
            ...
            real_out.append(
                {
                    ...
                    "Oración_HTML": html_add_mark_tag(output[idx]["Oración"], regex),
                    "Título_HTML": html_add_mark_tag(output[idx]["Título"], regex),
                }
            )
            if count == 5:
                break
